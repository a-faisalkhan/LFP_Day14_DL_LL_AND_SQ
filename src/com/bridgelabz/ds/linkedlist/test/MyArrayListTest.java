...
public class MyArrayListTest {
	...
	public void searchWithValue() {
		...
		System.out.println("----------------searchWithValue-----------------");
	...
	public void addAfterKey() {
		System.out.println("-----------------------addAfterKey---------------------");
		MyList<Integer> list = new MyArrayList<>();
	...
	public void removeKeyAndSize() {
		System.out.println("-----------------------removeKeyAndSize---------------------");
		MyList<Integer> list = new MyArrayList<>();
		...
		System.out.println("Before removing element size is : " + list.size());
		System.out.println(list);
		if (list.search(40)) {
			list.remove(40);
		}
		System.out.println("After removing element size is : " + list.size());
		System.out.println(list);
	}
